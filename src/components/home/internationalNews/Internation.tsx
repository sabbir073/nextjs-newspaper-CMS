...
const InternationlNews: React.FC = () => {
    ...
    return (
        <div className="">
            <div className="xl:max-w-7xl lg:max-w-5xl md:max-w-[768px] sm:max-w-[640px] xl:px-4 md:mx-auto lg:px-6 sm:mx-auto sm:px-4 px-3  lg:flex md:space-x-2 lg:space-x-4 space-y-4 md:space-y-0 pt-2 md:pt-0 mb-4">
                <div className=" w-full lg:w-3/">
                    {/* left side  */}

                    <div className='border-l-8 border-red-500 mb-2 mt-2 '>
                        <h1 className='text-black text-2xl md:text-4xl ml-4'> আন্তর্জাতিক </h1>
                    </div>
                    ...
                    <div className="space-y-1 md:space-y-0 md:space-x-1 pt-4 2xl:pt-10 w-full md:flex">
                        ...
                        <div className=" w-full md:w-7/12 grid grid-cols-1 pt-4 md:pt-0 gap-4 md:px-8 ">
                ...
                <div className="block lg:w-1/4">
                    {/* right side  */}
                    <div className='border-l-8 border-red-500 mb-2 mt-2 '>
                        <h1 className='text-black text-2xl md:text-4xl ml-4'> আইন-আদালত </h1>
                    </div>
...
export default InternationlNews;