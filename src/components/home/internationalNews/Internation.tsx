    ...
    <BodyContainer className="">
      <div className="mt-5 lg:flex md:space-x-2 lg:space-x-4 space-y-4 md:space-y-0 pt-2 md:pt-0">
        ...
        <div className="block lg:w-1/4 pt-5 lg:pt-0">
          ...
          <div className="flex items-center justify-between border bg-white shadow-md rounded-xl py-3">
            <div className="bg-gray-100 border-l-4 border-r-4 border-indigo-500 text-red-500 text-2xl md:text-xl px-2 rounded-full ml-4 cursor-pointer hover:bg-red-500 hover:text-white">
            আইন-আদালত
            </div>
            <div className="bg-red-500 text-2xl md:text-xl  px-4 rounded-full ml-4 cursor-pointer text-white mr-4 hover:bg-gray-100 hover:text-red-500">
              আরও
            </div>
          </div>
