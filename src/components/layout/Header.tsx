...
const Header: React.FC = () => {
    ...
    const formattedDateBn = getDate(date, { format: 'D MMMM, YYYY', calculationMethod: 'BD' });
    ...
    function closeDialog() {
        const dialog = document.getElementById('megaMenuModal') as HTMLDialogElement;
        if (dialog) {
            dialog.close();
        }
    }
            ...
            <BodyContainer>
                <div className='mx-auto'>
                    ...
                    <div className='sm:hidden flex justify-between items-center pt-6'>
                        <div>
                            <Link href='/'><Image className='w-[130px] mx-auto lg:ml-14 md:ml-14 ml-0' src={logo} alt='logo' /></Link>
                        </div>
                                            ...
                                            <BodyContainer>
                                                <div className='flex justify-between items-center py-7'>
                                                    <Link href={"/"} onClick={() => closeDialog()}>
                                                        <Image className='md:w-[180px] w-[150px]' src={logo} alt='logo' />
                                                    </Link>
                                                    <form method="dialog">
                                                        <button><RxCross2 className='md:text-4xl text-3xl' /></button>
                                                    </form>
                                                </div>
                                            </BodyContainer>
                                        </div>
            ...
            <dialog id="search_modal" className="modal bg-[#00000085]">
                <div className="modal-box min-w-[40%] py-8 md:py-10 px-7">
                    ...
                    <form className='space-y-3 mt-4'>
                        <input type="text" placeholder="এখানে লিখুন" className="input text-xl md:text-2xl h-[60px] input-bordered w-full" />
                        <Btn text={'খুজুন'} />
                    </form>
                </div>
            </dialog>
